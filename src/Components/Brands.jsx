...
const Brands = () => {
  return (
    <div className="flex flex-col items-center mt-6 md:mt-5 pt-10 pb-10 max-w-full" style={{backgroundColor: '#f6f6f6'}} >
        ...
        <h1 className="text-lg sm:text-md md:text-3xl text-center font-bold px-8" style={{color: '#222D35'}}>
